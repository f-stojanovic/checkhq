<?php
/**
 * CreateCompanyTaxElectionsRequestListOfTaxElectionsInnerSetting
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreateCompanyTaxElectionsRequestListOfTaxElectionsInnerSetting Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateCompanyTaxElectionsRequestListOfTaxElectionsInnerSetting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_company_tax_elections_request_List_of_Tax_Elections_inner_setting';
    ...
    */
     ...
     * Sets exempt
     *
     * @param bool $exempt Whether or not the tax is exempt.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime $effective_start The effective start date for the Tax Election setting value.
     *
     * @return self
     */
     ...
     * Sets effective_end
     *
     * @param \DateTime|null $effective_end The effective end date for the Tax Election setting value.
     *
     * @return self
     */
