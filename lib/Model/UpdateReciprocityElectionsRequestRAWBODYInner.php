<?php
/**
 * UpdateReciprocityElectionsRequestRAWBODYInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UpdateReciprocityElectionsRequestRAWBODYInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateReciprocityElectionsRequestRAWBODYInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_reciprocity_elections_request_RAW_BODY_inner';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['opt_in'] === null) {
            $invalidProperties[] = "'opt_in' can't be null";
        }
     ...
     * Sets opt_in
     *
     * @param bool $opt_in Opt-in value of the employee
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $effective_start Date the opt-in value goes into effect
     *
     * @return self
     */
     ...
     * Sets jurisdiction
     *
     * @param string $jurisdiction Jurisdiction ID for the associated election
     *
     * @return self
     */
