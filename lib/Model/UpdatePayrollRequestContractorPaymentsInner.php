...
/**
 * UpdatePayrollRequestContractorPaymentsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePayrollRequestContractorPaymentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_payroll_request_contractor_payments_inner';
    ...
    */
     ...
     * Sets contractor
     *
     * @param string $contractor The id of the contractor being paid
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string|null $amount The amount the contractor should be paid
     *
     * @return self
     */
     ...
     *
     * @param string|null $paper_check_number For accounting. The check number associated with any printed checks. Can be updated even after the associated payroll has been approved. See Get a paper check for more details.
     *
     * @return self
     */
