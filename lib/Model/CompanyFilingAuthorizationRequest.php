...
/**
 * CompanyFilingAuthorizationRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CompanyFilingAuthorizationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'company_filing_authorization_request';
    ...
    */
     ...
     * Sets signatory
     *
     * @param string|null $signatory The ID of the signatory object for this company. You may use either a signatory ID or the three signatory body params above
     *
     * @return self
     */
     ...
     * Sets jurisdiction
     *
     * @param string|null $jurisdiction Only list forms of the given jurisdiction. Use the last 2 letters of the ISO 3166-2:US code for the jurisdiction.
     *
     * @return self
     */
     ...
     * Sets federal_only
     *
     * @param bool|null $federal_only Only show Federal forms if True.
     *
     * @return self
     */
