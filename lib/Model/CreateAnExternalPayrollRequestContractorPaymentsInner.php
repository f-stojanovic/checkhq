<?php
/**
 * CreateAnExternalPayrollRequestContractorPaymentsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreateAnExternalPayrollRequestContractorPaymentsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateAnExternalPayrollRequestContractorPaymentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_an_external_payroll_request_contractor_payments_inner';
    ...
    */
     ...
     * Sets amount
     *
     * @param string|null $amount Amount paid to this contractor
     *
     * @return self
     */
     ...
     *
     * @param string|null $reimbursement_amount Amount reimbursed to the contractor
     *
     * @return self
     */
     ...
     * Sets contractor
     *
     * @param string|null $contractor ID of the contractor paid
     *
     * @return self
     */
