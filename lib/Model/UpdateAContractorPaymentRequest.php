...
/**
 * UpdateAContractorPaymentRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateAContractorPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_a_contractor_payment_request';
    ...
    */
     ...
     * Sets contractor
     *
     * @param string|null $contractor ID of the contractor to pay
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string|null $amount The amount the contractor will be paid
     *
     * @return self
     */
