<?php
/**
 * CompanySignatoryAgreementsRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CompanySignatoryAgreementsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CompanySignatoryAgreementsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'company_signatory_agreements_request';
    ...
    */
     ...
     * Sets signatory
     *
     * @param string $signatory The ID of the signatory object for this company. You must provide either a signatory ID (recommended) or all three body params shown below
     *
     * @return self
     */
     ...
     * Sets signer_name
     *
     * @param string|null $signer_name The name of the person who has permission to onboard on behalf of the company.
     *
     * @return self
     */
     ...
     * Sets signer_title
     *
     * @param string|null $signer_title The title of the person who has permission to onboard on behalf of the company (e.g. \"Officer\", \"Manager\", etc.).
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email The email of the person who has permission to onboard on behalf of the company
     *
     * @return self
     */
