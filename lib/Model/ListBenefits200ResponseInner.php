...
/**
 * ListBenefits200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListBenefits200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'list_benefits_200_response_inner';
    ...
    */
     ...
     *
     * @param mixed|null $company_benefit company_benefit
     *
     * @return self
     */
    public function setCompanyBenefit($company_benefit)
    {
        if (is_null($company_benefit)) {
            array_push($this->openAPINullablesSetToNull, 'company_benefit');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('company_benefit', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param mixed|null $hsa_contribution_limit hsa_contribution_limit
     *
     * @return self
     */
    public function setHsaContributionLimit($hsa_contribution_limit)
    {
        if (is_null($hsa_contribution_limit)) {
            array_push($this->openAPINullablesSetToNull, 'hsa_contribution_limit');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('hsa_contribution_limit', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
