...
/**
 * CreateAnExternalPayrollRequestItemsInnerBenefitsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateAnExternalPayrollRequestItemsInnerBenefitsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_an_external_payroll_request_items_inner_benefits_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id ID of the benefit object that represents this deduction. One of `ID` or `benefit` must be provided.
     *
     * @return self
     */
     ...
     * Sets benefit
     *
     * @param string|null $benefit The [benefit type](https://docs.checkhq.com/reference/types-of-benefits) of this deduction. Either `id` or `benefit` must be provided.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description of the benefit provided. If ID is provided, this field will not take effect and instead be superseded by the benefit object's description.
     *
     * @return self
     */
     ...
     *
     * @param string|null $employee_contribution_amount Amount the employee contributed to the benefit for this payroll
     *
     * @return self
     */
     ...
     *
     * @param string|null $company_contribution_amount Amount the company contributed to this benefit for this payroll
     *
     * @return self
     */
