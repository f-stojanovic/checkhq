...
/**
 * CreateAnEmployeeBenefitRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateAnEmployeeBenefitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_an_employee_benefit_request';
    ...
    */
     ...
     * Sets employee
     *
     * @param string $employee ID of the employee associated with the benefit.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Optional description to distinguish the benefit within a plan. Maximum length of 255 characters.
     *
     * @return self
     */
