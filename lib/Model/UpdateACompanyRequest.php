...
/**
 * UpdateACompanyRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateACompanyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_a_company_request';
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email Email address of payroll department or payroll administrator
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone Phone number for the company
     *
     * @return self
     */
     ...
     *
     * @param string|null $principal_place_of_business Company's workplace ID whose address would be printed on paystub, instead of legal address.
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param \DateTime|null $start_date Date the company will start using Check as their payroll processor
     *
     * @return self
     */
