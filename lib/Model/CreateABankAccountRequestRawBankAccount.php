<?php
/**
 * CreateABankAccountRequestRawBankAccount
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CreateABankAccountRequestRawBankAccount Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateABankAccountRequestRawBankAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_a_bank_account_request_raw_bank_account';
    ...
    */
     ...
     * Sets account_number
     *
     * @param string $account_number The account’s account number
     *
     * @return self
     */
     ...
     * Sets routing_number
     *
     * @param string $routing_number The account’s routing number
     *
     * @return self
     */
     ...
     *
     * @param string|null $institution_name The name of the bank holding the account
     *
     * @return self
     */
     ...
     * Sets subtype
     *
     * @param string $subtype The account’s subtype. Values may be `checking` or `savings`
     *
     * @return self
     */
