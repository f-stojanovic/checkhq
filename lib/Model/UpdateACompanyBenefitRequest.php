...
/**
 * UpdateACompanyBenefitRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateACompanyBenefitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_a_company_benefit_request';
    ...
    */
     ...
     * Sets company
     *
     * @param string|null $company ID of the company associated with the benefit.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description to distinguish the benefit from other company benefits of the same type. Maximum length of 255 characters.
     *
     * @return self
     */
