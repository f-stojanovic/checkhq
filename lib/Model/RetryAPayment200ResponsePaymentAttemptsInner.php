<?php
/**
 * RetryAPayment200ResponsePaymentAttemptsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RetryAPayment200ResponsePaymentAttemptsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RetryAPayment200ResponsePaymentAttemptsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'retry_a_payment_200_response_payment_attempts_inner';
    ...
    protected static $openAPITypes = [
        ...
        'payment_instrument' => 'mixed',
        'wire_details' => '\OpenAPI\Client\Model\GetAPayment200ResponsePaymentAttemptsInnerWireDetails'
    ];
    ...
    */
     ...
     *
     * @param mixed|null $payment_instrument payment_instrument
     *
     * @return self
     */
    public function setPaymentInstrument($payment_instrument)
    {
        if (is_null($payment_instrument)) {
            array_push($this->openAPINullablesSetToNull, 'payment_instrument');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payment_instrument', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets wire_details
     *
     * @return \OpenAPI\Client\Model\GetAPayment200ResponsePaymentAttemptsInnerWireDetails|null
     */
     ...
     * Sets wire_details
     *
     * @param \OpenAPI\Client\Model\GetAPayment200ResponsePaymentAttemptsInnerWireDetails|null $wire_details wire_details
     *
     * @return self
     */
    public function setWireDetails($wire_details)
    {
        if (is_null($wire_details)) {
            throw new \InvalidArgumentException('non-nullable wire_details cannot be null');
        }
