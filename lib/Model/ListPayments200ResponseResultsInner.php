...
/**
 * ListPayments200ResponseResultsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListPayments200ResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'list_payments_200_response_results_inner';
    ...
    protected static $openAPITypes = [
        ...
        'parent_type' => 'string',
        'parent_id' => 'string',
        'payment_attempts' => '\OpenAPI\Client\Model\ListPayments200ResponseResultsInnerPaymentAttemptsInner[]',
        'can_retry' => 'bool',
        'can_refund' => 'bool',
        'can_cancel' => 'bool',
    ...
    protected static $setters = [
        ...
        'cancel_deadline' => 'setCancelDeadline',
    ...
    protected static $getters = [
        ...
        'cancel_deadline' => 'getCancelDeadline',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('can_cancel', $data ?? [], true);
        $this->setIfExists('cancel_deadline', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\ListPayments200ResponseResultsInnerPaymentAttemptsInner[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ListPayments200ResponseResultsInnerPaymentAttemptsInner[]|null $payment_attempts payment_attempts
     *
     * @return self
     */
    ...
    /**
     * Gets cancel_deadline
     *
     * @return string|null
     */
    public function getCancelDeadline()
    {
        return $this->container['cancel_deadline'];
    }

    /**
     * Sets cancel_deadline
     *
     * @param string|null $cancel_deadline cancel_deadline
     *
     * @return self
     */
    public function setCancelDeadline($cancel_deadline)
    {
        if (is_null($cancel_deadline)) {
            throw new \InvalidArgumentException('non-nullable cancel_deadline cannot be null');
        }
        $this->container['cancel_deadline'] = $cancel_deadline;
