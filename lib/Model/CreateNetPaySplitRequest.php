...
/**
 * CreateNetPaySplitRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateNetPaySplitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_net_pay_split_request';
    ...
    protected static $openAPITypes = [
        'employee' => 'string',
        'contractor' => 'string',
        'splits' => '\OpenAPI\Client\Model\CreateNetPaySplitRequestSplitsInner[]',
        'is_default' => 'bool'
    ];
    ...
    */
     ...
     * Sets employee
     *
     * @param string|null $employee ID of the employee that the net pay split relates to.
     *
     * @return self
     */
     ...
     * Sets contractor
     *
     * @param string|null $contractor ID of the contractor that the net pay split relates to.
     *
     * @return self
     */
     ...
     * Gets splits
     *
     * @return \OpenAPI\Client\Model\CreateNetPaySplitRequestSplitsInner[]
     */
     ...
     * Sets splits
     *
     * @param \OpenAPI\Client\Model\CreateNetPaySplitRequestSplitsInner[] $splits Prioritized list of bank accounts and the maximum amounts to be paid to each account.  The amount / percentage can be omitted for the lowest priority account.
     *
     * @return self
     */
