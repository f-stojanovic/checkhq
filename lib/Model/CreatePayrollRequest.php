...
/**
 * CreatePayrollRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreatePayrollRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_payroll_request';
    ...
    protected static $openAPITypes = [
        ...
        'pay_schedule' => 'string',
        'off_cycle_options' => '\OpenAPI\Client\Model\CreatePayrollRequestOffCycleOptions',
    ...
    */
     ...
     * Sets company
     *
     * @param string $company ID of the company to run payroll for.
     *
     * @return self
     */
     ...
     * Sets payday
     *
     * @param \DateTime $payday The date on which employees will be paid for the payroll.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Indicates whether the payroll is a regular, [off-cycle](doc:off-cycle-payroll), or amendment payroll.<br><br>One of `regular`,`off_cycle`, or `amendment`.<br><br>Default: `regular`
     *
     * @return self
     */
     ...
     * Sets pay_frequency
     *
     * @param string|null $pay_frequency Frequency by which [employees](ref:the-employee-object) get paid.<br><br>One of `weekly`, `biweekly`, `semimonthly`, `monthly`, `quarterly`, or `annually`.<br><br>Default: `biweekly`
     *
     * @return self
     */
     ...
     *
     * @param string|null $funding_payment_method Payment method for funding the payroll. <br><br>One of `ach` or `wire`. <br><br>Default: `ach`
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\CreatePayrollRequestOffCycleOptions|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CreatePayrollRequestOffCycleOptions|null $off_cycle_options off_cycle_options
     *
     * @return self
     */
