...
/**
 * UpdateAContractorRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateAContractorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_a_contractor_request';
    ...
    */
     ...
     * Sets first_name
     *
     * @param string|null $first_name Contractor's first name
     *
     * @return self
     */
     ...
     * Sets middle_name
     *
     * @param string|null $middle_name Contractor's middle name
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name Contractor's last name
     *
     * @return self
     */
     ...
     * Sets business_name
     *
     * @param string|null $business_name Contractor's business name if they are a business
     *
     * @return self
     */
