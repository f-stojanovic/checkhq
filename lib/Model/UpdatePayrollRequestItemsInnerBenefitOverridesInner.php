<?php
/**
 * UpdatePayrollRequestItemsInnerBenefitOverridesInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UpdatePayrollRequestItemsInnerBenefitOverridesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePayrollRequestItemsInnerBenefitOverridesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_payroll_request_items_inner_benefit_overrides_inner';
    ...
    */
     ...
     * Sets benefit
     *
     * @param string $benefit ID of the employee benefit that is being overridden for the payroll item
     *
     * @return self
     */
     ...
     *
     * @param string|null $employee_contribution_amount Updated employee contribution amount to use for this payroll only
     *
     * @return self
     */
     ...
     *
     * @param string|null $company_contribution_amount Updated company contribution amount to use for this payroll only
     *
     * @return self
     */
