...
/**
 * UpdateAPostTaxDeductionRequestChildSupport Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateAPostTaxDeductionRequestChildSupport implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_a_post_tax_deduction_request_child_support';
    ...
    */
     ...
     * Sets external_id
     *
     * @param string|null $external_id The unique identifier of the order
     *
     * @return self
     */
     ...
     * Sets agency
     *
     * @param string|null $agency The state abbreviation of the agency that issued the order
     *
     * @return self
     */
     ...
     * Sets fips_code
     *
     * @param string|null $fips_code An optional 5 or 7 digit number used to identify the correct agency within the state. This should be provided if present in the order.
     *
     * @return self
     */
     ...
     * Sets issue_date
     *
     * @param \DateTime|null $issue_date The date the collections agency issued the order
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string|null $amount Per pay period amount to deduct
     *
     * @return self
     */
     ...
     * Sets max_percent
     *
     * @param float|null $max_percent The maximum percent of disposable income that can be deducted
     *
     * @return self
     */
