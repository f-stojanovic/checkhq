...
/**
 * CreateTheEnrollmentProfileRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateTheEnrollmentProfileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_the_enrollment_profile_request';
    ...
    */
     ...
     *
     * @param string|null $pay_period_amount Estimated total amount of money paid to employees and contractors per pay period
     *
     * @return self
     */
