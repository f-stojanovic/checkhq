...
/**
 * CreateAPayrollItemRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateAPayrollItemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'create_a_payroll_item_request';
    ...
    */
     ...
     * Sets payroll
     *
     * @param string $payroll The payroll ID associated with the payroll item.
     *
     * @return self
     */
     ...
     * Sets employee
     *
     * @param string $employee The employee ID associated with the payroll item.
     *
     * @return self
     */
     ...
     * Sets payment_method
     *
     * @param string|null $payment_method May be `manual` or `direct_deposit` if the employee has a linked bank account
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\UpdatePayrollRequestItemsInnerPostTaxDeductionOverridesInner[]|null $post_tax_deduction_overrides The set of post-tax deduction override objects associated with this payroll item.
     *
     * @return self
     */
     ...
     *
     * @param float|null $pto_balance_hours The employee's remaining PTO hour balance, for display on the paystub
     *
     * @return self
     */
     ...
     *
     * @param float|null $sick_balance_hours The employee's remaining sick hour balance, for display on the paystub
     *
     * @return self
     */
