<?php
/**
 * GetAnEmployeesPaystubs200ResponseResultsInnerTimeOffBalances
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetAnEmployeesPaystubs200ResponseResultsInnerTimeOffBalances Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetAnEmployeesPaystubs200ResponseResultsInnerTimeOffBalances implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_an_employees_paystubs_200_response_results_inner_time_off_balances';
    ...
    protected static $openAPITypes = [
        'pto_balance_hours' => 'mixed',
        'sick_balance_hours' => 'mixed',
        'state_covid_sick_balance_hours' => 'mixed'
    ];
    ...
    protected static array $openAPINullables = [
        'pto_balance_hours' => true,
        'sick_balance_hours' => true,
        'state_covid_sick_balance_hours' => true
    ];
    ...
    */
     ...
     *
     * @param mixed|null $pto_balance_hours pto_balance_hours
     *
     * @return self
     */
    public function setPtoBalanceHours($pto_balance_hours)
    {
        if (is_null($pto_balance_hours)) {
            array_push($this->openAPINullablesSetToNull, 'pto_balance_hours');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pto_balance_hours', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param mixed|null $sick_balance_hours sick_balance_hours
     *
     * @return self
     */
    public function setSickBalanceHours($sick_balance_hours)
    {
        if (is_null($sick_balance_hours)) {
            array_push($this->openAPINullablesSetToNull, 'sick_balance_hours');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sick_balance_hours', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param mixed|null $state_covid_sick_balance_hours state_covid_sick_balance_hours
     *
     * @return self
     */
    public function setStateCovidSickBalanceHours($state_covid_sick_balance_hours)
    {
        if (is_null($state_covid_sick_balance_hours)) {
            array_push($this->openAPINullablesSetToNull, 'state_covid_sick_balance_hours');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('state_covid_sick_balance_hours', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
